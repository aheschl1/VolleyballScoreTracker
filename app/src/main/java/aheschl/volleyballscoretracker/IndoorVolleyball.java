...
class IndoorVolleyball extends VolleyballMatch {
    ...
    void homeScoreUp(MainActivity mainActivity) {
        ...
        if(mainActivity.mySharedPreferences.getNotifyAtEnd() == Constants.ON) {
            ...
            if (mainActivity.isTieBreaker() && mainActivity.mySharedPreferences.get15PointTieBreaker()) {
                ...
                if (homeScore == 8 && awayScore < 8) {
                    ...
                    if (mainActivity.mySharedPreferences.getShowMessageForSideChange() == Constants.ON) {
                        ...
                        new AlertDialog.Builder(mainActivity)
                                ...
                                .setMessage(mainActivity.mySharedPreferences.getHomeTeamName() + " has made it to 8 points in the tie breaker. " +
                ...
                } else if (homeScore > 14 && homeScore - 1 > awayScore) {
                ...
                if (homeScore > 24 && homeScore - 1 > awayScore) {
        ...
        super.homeScoreUp(mainActivity);
    ...
    void awayScoreUp(MainActivity mainActivity) {
        ...
        /*if(mainActivity.homeButtonIndex != 0) {

            mainActivity.rightIndicator.setVisibility(View.INVISIBLE);
            mainActivity.leftIndicator.setVisibility(View.VISIBLE);

        }else{

            mainActivity.rightIndicator.setVisibility(View.VISIBLE);
            mainActivity.leftIndicator.setVisibility(View.INVISIBLE);
        ...
        if(mainActivity.mySharedPreferences.getNotifyAtEnd() == Constants.ON) {
            ...
            if (mainActivity.isTieBreaker()&& mainActivity.mySharedPreferences.get15PointTieBreaker()) {
                ...
                if (awayScore == 8 && homeScore < 8) {

                    if (mainActivity.mySharedPreferences.getShowMessageForSideChange() == Constants.ON) {

                        new AlertDialog.Builder(mainActivity)
                                .setTitle("Switch sides")
                                .setMessage(mainActivity.mySharedPreferences.getAwayTeamName() + " has made it to 8 points in the tie breaker. " +
                                        "Click SWITCH SIDES to change sides. - You can turn off this prompt in settings.")
                                .setPositiveButton("SWITCH SIDES", (dialogInterface, i) -> mainActivity.changeSides()).setNegativeButton("DON'T SWITCH SIDES", null).setCancelable(false).show();
                    } else {
                ...
                } else if (awayScore > 14 && awayScore - 1 > homeScore) {
                ...
                if (awayScore > 24 && awayScore - 1 > homeScore) {
        ...
        super.awayScoreUp(mainActivity);
    ...
    void awayScoreDown(MainActivity mainActivity) {
        ...
        super.awayScoreDown(mainActivity);
    }
    ...
    void homeScoreDown(MainActivity mainActivity) {
        ...
        super.homeScoreDown(mainActivity);
